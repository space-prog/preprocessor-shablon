...
export const compileMixins = () => {
    return gulp
    .src("src/pug/components/*.pug")
    .pipe(pug())
    .pipe(rename({ extname: '.blade.php' }))
    .pipe(gulp.dest("resources/views/components"))
...
export const watch = () => {
    ...
    gulp.watch("src/pug//*.pug", gulp.parallel(html, pugToBlade, compileMixins))
